    ...
    <div className="max-w-md mx-auto w-full text-base text-gray-800 dark:text-gray-400 p-5">
      ...
      <footer>
        <ul className="mt-10 w-full flex items-center justify-center space-x-2">
          <li className="w-6">
            <Link rel="noopener noreferrer" href={t('githubUrl')} className="block opacity-75 hover:opacity-100 transition-opacity duration-300 ease-in-out">
          ...
          <li className="w-6">
            <Link rel="noopener noreferrer" href={t('linkedinUrl')} className="block opacity-75 hover:opacity-100 transition-opacity duration-300 ease-in-out">
