    ...
    <div className="max-w-md mx-auto w-full text-base text-gray-800 dark:text-gray-400 p-5">
      ...
      <footer>
        <ul className="mt-10 w-full flex items-center justify-center">
          ...
          <li className="w-8 mx-5">
            <a rel="nofollow" href="https://codepen.io/sannremy" className="block opacity-75 hover:opacity-100 transition-opacity duration-300 ease-in-out">
        ...
        <div className="text-sm text-gray-500 flex items-center justify-center mt-5">
          <span>hello</span>
