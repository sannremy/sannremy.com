      ...
      <div className="max-w-md mx-auto w-full text-gray-800 dark:text-gray-400 p-5 transition-colors duration-150 ease-in-out">
        ...
        <footer>
          <ul className="mt-10 mx-auto w-full flex items-center justify-between" style={{
            ...
            <li className="w-8">
              <a data-goatcounter-click="ext-github.com" rel="nofollow" href="https://github.com/srchea" className="block hover:opacity-75 transition-opacity duration-150 ease-in-out">
            ...
            <li className="w-8">
              <a data-goatcounter-click="ext-codepen.io" rel="nofollow" href="https://codepen.io/srchea" className="block hover:opacity-75 transition-opacity duration-150 ease-in-out">
            ...
            <li className="w-8">
              <a data-goatcounter-click="ext-linkedin.com" rel="nofollow" href="https://www.linkedin.com/in/srchea" className="block hover:opacity-75 transition-opacity duration-150 ease-in-out">
