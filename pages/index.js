...
export default function Home() {
  ...
  const siteUrl = intl.formatMessage({
    id: "siteUrlLocale",
    defaultMessage: "",
  })
  ...
  return (
    <div className="max-w-md mx-auto w-full text-base text-gray-800 dark:text-gray-400 p-5 transition-colors duration-150 ease-in-out">
      ...
      <main>
        <div className="flex items-center justify-center flex-col">
          ...
          <div className="flex items-center justify-end w-full mb-5">
            <span onClick={() => setDarkMode(!isDarkMode)} className="block mr-1 flex items-center px-2 py-2 border border-gray-300 dark:border-gray-700 hover:border-gray-700 dark-hover:border-gray-500 cursor-pointer transition-colors duration-150 ease-in-out rounded-full">
              <span className="flex-none block w-4">
                {isDarkMode && (
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            >
              <span className="block text-sm flex items-center px-2 py-1 border border-gray-300 dark:border-gray-700 hover:border-gray-700 dark-hover:border-gray-500 cursor-pointer transition-colors duration-150 ease-in-out rounded-full">
      ...
      {/* Social links */}
      <footer>
        <ul className="mt-10 mx-auto w-full flex items-center justify-center">
          <li className="flex-none w-8 mr-10">
            <a rel="nofollow" href="https://github.com/sannremy" className="block hover:opacity-75 transition-opacity duration-150 ease-in-out">
          ...
          <li className="flex-none w-8 mr-10">
            <a rel="nofollow" href="https://codepen.io/sannremy" className="block hover:opacity-75 transition-opacity duration-150 ease-in-out">
          ...
          <li className="flex-none w-8">
            <a rel="nofollow" href="https://www.linkedin.com/in/sannremy" className="block hover:opacity-75 transition-opacity duration-150 ease-in-out">
              <svg className="fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fillRule="evenodd" clipRule="evenodd" strokeLinejoin="round" strokeMiterlimit="1.414"><path fillRule="nonzero" d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/></svg>
            </a>
          </li>
        </ul>

        <p className="text-sm text-gray-600 flex items-center justify-center mt-5">
          <span>hello</span>
