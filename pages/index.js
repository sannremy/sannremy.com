      ...
      <main>
        <div className="flex items-center justify-center flex-col">
          ...
          <div className="flex items-center justify-center w-full mb-5">
            <span onClick={() => setDarkMode(!isDarkMode)} className="mr-1 block text-sm flex items-center px-2 py-1 border border-gray-300 dark:border-gray-700 hover:border-gray-700 dark-hover:border-gray-500 cursor-pointer transition-colors duration-150 ease-in-out rounded-full">
