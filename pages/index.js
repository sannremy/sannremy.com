      ...
      <div className="max-w-md mx-auto w-full text-gray-800 dark:text-gray-400 p-5 transition-colors duration-150 ease-in-out">
        ...
        <main>
          <div className="flex items-center justify-center flex-col">
            ...
            <div className="flex items-center justify-end w-full mb-1">
              <div title="Dark mode" data-goatcounter-click="act-darkmode" onClick={this.handleDarkMode} className="flex items-center w-6 h-6 p-1 border border-gray-300 dark:border-gray-700 hover:border-gray-700 dark-hover:border-gray-500 cursor-pointer transition-colors duration-150 ease-in-out rounded-full">
            ...
            {/* Picture + Name + Role */}
            <Link href="/">
              <a data-goatcounter-click="int-root" className="block w-32 mx-auto border border border-gray-300 dark:border-gray-700 hover:border-gray-700 dark-hover:border-gray-500 transition-colors duration-150 ease-in-out rounded-full p-1">
        ...
        <footer>
          <ul className="mt-10 mx-auto w-full flex items-center justify-between" style={{
            ...
            <li className="w-8">
              <a data-goatcounter-click="ext-github.com" rel="nofollow" href="https://github.com/sannremy" className="block hover:opacity-75 transition-opacity duration-150 ease-in-out">
            ...
            <li className="w-8">
              <a data-goatcounter-click="ext-codepen.io" rel="nofollow" href="https://codepen.io/sannremy" className="block hover:opacity-75 transition-opacity duration-150 ease-in-out">
            ...
            <li className="w-8">
              <a data-goatcounter-click="ext-linkedin.com" rel="nofollow" href="https://www.linkedin.com/in/sannremy" className="block hover:opacity-75 transition-opacity duration-150 ease-in-out">
