...
export default function Home() {
  return (
    <div className="max-w-md mx-auto w-full text-gray-800 p-5">
      <Head>
        <title>Sann-Remy Chea Online</title>
      ...
      <main>
        <div className="flex item-center justify-center flex-col">
          <Link href="/">
            <a className="block w-32 mx-auto border border-gray-300 hover:border-gray-700 transition-colors duration-150 ease-in-out rounded-full p-1">
      ...
      <footer>
        <ul className="mt-10 mx-auto w-full flex items-center justify-between" style={{
          ...
          <li className="w-8">
            <a rel="nofollow" href="https://github.com/srchea" className="block hover:opacity-75 transition-opacity duration-150 ease-in-out">
          ...
          <li className="w-8">
            <a rel="nofollow" href="https://codepen.io/srchea" className="block hover:opacity-75 transition-opacity duration-150 ease-in-out">
          ...
          <li className="w-8">
            <a rel="nofollow" href="https://www.linkedin.com/in/srchea" className="block hover:opacity-75 transition-opacity duration-150 ease-in-out">
