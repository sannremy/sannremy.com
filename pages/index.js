...
export default class Home extends React.Component {
  ...
  handleTracking(event, eventType, eventProperties = null) {
    if (event) {
      ...
      <div className="max-w-md mx-auto w-full text-gray-800 p-5">
        ...
        <main>
          <div className="flex item-center justify-center flex-col">
            <Link href="/">
              <a onClick={e => this.handleTracking(e, 'click', { label: 'header-picture-link' })} className="block w-32 mx-auto border border-gray-300 hover:border-gray-700 transition-colors duration-150 ease-in-out rounded-full p-1">
